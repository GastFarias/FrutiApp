...
public class MainActivity2_Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2__nivel6);
    ...
    public void Comparar(View view) {
        ...
        if (!respuesta.equals("")) {
            ...
            if (resultado == respuesta_jugador) {
                ...
                vidas--;
                BaseDeDatos();
                Toast.makeText(this, "El Resultado era: " + resultado, Toast.LENGTH_LONG).show();
    ...
    public void NumAleatorio() {
        if (score <= 1000) {
            ...
            Toast.makeText(this, "Un Genio ! ! ! Terminaste todos los Niveles", Toast.LENGTH_SHORT).show();
